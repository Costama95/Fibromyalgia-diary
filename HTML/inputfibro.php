...
<div class="circlemenu">
	<ul>
	<li><a href="#line1" class="w3-bar-item w3-button"><span>Kipu</span></a></li>
	<li><a href="#line2" class="w3-bar-item w3-button"><span>Väsymys</span></a></li>
	<li><a href="#line3" class="w3-bar-item w3-button"><span>Uni</span></a></li>
	<li><a href="#line4" class="w3-bar-item w3-button"><span>Liikunta</span></a></li>
	<li><a href="#line5" class="w3-bar-item w3-button"><span>Stressi</span></a></li>
	</ul>
		</div>			
</div>

		
	<!-- Fastnavigation to pain etc. TÄSSÄ VANHA FASTNAVI, POISTA SIT LOPUKSI
	<div class="fastnav">
