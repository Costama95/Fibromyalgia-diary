   ...
   <body>
      ...
      <nav class="w3-top">
         <div class="w3-bar" id="myNavbar">
            ...
            <a href="index.php" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i> OSA-ALUEET</a>
         ...
         <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
            <a href="index.php" class="w3-bar-item w3-button" onclick="toggleFunction()">OSA-ALUEET</a>
